...
// different tolerances required for float/double
  ...
  SECTION("simple CMAQ_H2O2") {
    std::string prefix = HAERO_TEST_DATA_DIR;
    std::string input_file = prefix;
    input_file += "/config_cmaq_h2o2.yaml";
    std::string refsol_file = prefix;
  ...
  SECTION("simple CMAQ_OH_HNO3") {
    std::string prefix = HAERO_TEST_DATA_DIR;
    std::string input_file = prefix;
    input_file += "/config_cmaq_oh_hno3.yaml";
    std::string refsol_file = prefix;
  ...
  SECTION("simple emission") {
    std::string prefix = HAERO_TEST_DATA_DIR;
    std::string input_file = prefix;
    input_file += "/config_emission.yaml";
    std::string refsol_file = prefix;
