...
module modal_aero_data
  ...
  use modal_aero_config, only: nbc, npoa, nsoa, nsoag
  ...
  real(wp), parameter :: specmw_amode(ntot_aspectype)   = (/ 115.0_wp, 115.0_wp,  62.0_wp, &
    12.0_wp,   12.0_wp,   12.0_wp,  58.5_wp, 135.0_wp, &
    250092.0_wp /)
  ...
  ! Define a dummy fix time scale used for the test
  ! in the cloud and gas chemistry
  real(wp), parameter ::    tau_simple_chem = 1800._wp

  !   input dgnum_amode, dgnumlo_amode, dgnumhi_amode (units = m)
  real(wp) :: dgnum_amode(ntot_amode)
  real(wp) :: dgnumlo_amode(ntot_amode)
  real(wp) :: dgnumhi_amode(ntot_amode)

  !   input sigmag_amode
  real(wp) :: sigmag_amode(ntot_amode)

  !   input crystalization and deliquescence points
  real(wp) :: rhcrystal_amode(ntot_amode)
  real(wp) :: rhdeliques_amode(ntot_amode)
  ...
  real(wp) :: specmw2_amode(ntot_aspectype,ntot_amode)
  real(wp) :: specdens2_amode(ntot_aspectype,ntot_amode)
  real(wp) :: spechygro2(ntot_aspectype,ntot_amode)
  ...
  real(wp) :: qneg3_worst_thresh_amode(pcnst)
