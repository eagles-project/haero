...
TEST_CASE("mode_ctor", "") {
  ...
  //For single precision calculations, we expect accuracy till 7 decimal digits (1e-7)
  static constexpr Real exp_sngl_prc_accuracy = 1e-7;// expected single precision accuracy
