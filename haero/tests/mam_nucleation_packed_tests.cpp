...
TEST_CASE("ternary_nuc_merik2007_test", "mam_nucleation_packed") {
  ...
  for (int i=0; i<1000; i+=PackType::n) {
    ...
    for (int p=0; p<PackType::n; ++p) {
      ...
      c2_p[p] = c2;
      c3_p[p] = c3;
std::cout<<__FILE__<<":"<<__LINE__<<" "<<p<<" t:"<< t <<" rh:"<<rh <<std::endl;
std::cout<<__FILE__<<":"<<__LINE__<<" "<<p<<" c2:"<< c2 <<" c3:"<<c3 <<std::endl;
    }
...
std::cout<<__FILE__<<":"<<__LINE__<<" j_log_p[0]:"<< j_log_p[0] <<std::endl;
...
std::cout<<__FILE__<<":"<<__LINE__<<" "<<p<<" t:"<< t <<" rh:"<<rh <<std::endl;
std::cout<<__FILE__<<":"<<__LINE__<<" "<<p<<" c2:"<< c2 <<" c3:"<<c3 <<std::endl;
std::cout<<__FILE__<<":"<<__LINE__<<" "<<p<<" j_log_dbl:"<< j_log_dbl <<" j_log_pck:"<<j_log_pck <<std::endl;
...
TEST_CASE("binary_nuc_vehk2002", "mam_nucleation_packed") {
  ...
  for (int i=0; i<1000; ++i) {
    ...
    Kokkos::parallel_for("binary_nuc_vehk2002.mam_nucleation_packed", 1,
...
TEST_CASE("mer07_veh02_nuc_mosaic_1box", "mam_nucleation_packed") {
  ...
  for (int i=0; i<1000; ++i) {
    ...
    Kokkos::parallel_for("mer07_veh02_nuc_mosaic_1box.mam_nucleation_packed", 1,
      KOKKOS_LAMBDA(const int) {
        int    isize_nuc    = 0;
        double qnuma_del    = 0;
        double qso4a_del    = 0;
