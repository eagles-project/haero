...
void generate_plots(const std::string& filename,
                    const std::string& title,
                    const std::string& x_label,
                    const std::string& y_label,
...
TEST_CASE("vehkamaki2002_figure_7") {
  ...
  auto J = generate_output(temp, rel_hum, [=](PackType RH, PackType T) {
    return vehkamaki2002::h2so4_nucleation_threshold(T, RH);
    });
  generate_plots("vehkamaki2002_figure_7.py", "Nucleation rate",
...
TEST_CASE("vehkamaki2002_sp_figure_11.11") {
  ...
  generate_plot("vehkamaki2002_sp_figure_11.11.py",
...
TEST_CASE("vehkamaki2002_figure_8_dotted") {
  ...
  generate_plot("vehkamaki2002_figure_8_dotted.py",
...
TEST_CASE("vehkamaki2002_figure_8_dashed") {
  ...
  generate_plot("vehkamaki2002_figure_8_dashed.py",
