...
TEST_CASE("vehkamaki2002_sp_figure_11.11") {
  ...
  generate_curve_plot("vehkamaki2002_sp_figure_11.11.py",
                      ...
                      "Relative humidity", "linear", "Mole fraction", "linear",
                      rel_hum, x_crit);
}
...
TEST_CASE("vehkamaki2002_figure_8_dotted") {
  ...
  auto J = generate_output(c_h2so4, [=](PackType c) {
    auto x_crit =
        vehkamaki2002::h2so4_critical_mole_fraction(c, temp, rel_hum);
    return vehkamaki2002::nucleation_rate(c, temp, rel_hum, x_crit);
  });
  generate_curve_plot("vehkamaki2002_figure_8_dotted.py",
                      "Nucleation Rate", "H2SO4 concentration", "log",
                "J [#/cm3]", "log", c_h2so4, J);
}
...
TEST_CASE("vehkamaki2002_figure_9") {
  ...
  generate_curve_plot("vehkamaki2002_figure_9a.py",
                      "298K, RH=38.2%", "H2SO4 concentration [#/cc]", "linear",
                      "Nucleation rate [#/cc/s]", "log", c_h2so4, J,
                      0, 4e10, 1e-3, 1e6);
  rel_hum = 0.523;
  ...
  generate_curve_plot("vehkamaki2002_figure_9b.py",
                      "298K, RH=52.3%", "H2SO4 concentration [#/cc]", "linear",
                      "Nucleation rate [#/cc/s]", "log", c_h2so4, J,
                      0, 4e10, 1e-3, 1e6);
}
...
TEST_CASE("vehkamaki2002_figure_10") {
  ...
  generate_curve_plot("vehkamaki2002_figure_10a.py",
                      "295.15K, RH=7.5%", "H2SO4 concentration [#/cc]", "log",
                      "Nucleation rate [#/cc/s]", "log", c_h2so4, J,
                      1e10, 1e12, 1e-2, 1e5);
  rel_hum = 0.153;
  J = generate_output(c_h2so4, [=](PackType c) {
  ...
  generate_curve_plot("vehkamaki2002_figure_10b.py",
                      "295.15K, RH=15.3%", "H2SO4 concentration [#/cc]", "log",
                      "Nucleation rate [#/cc/s]", "log", c_h2so4, J,
                      1e10, 1e12, 1e-2, 1e5);
}
