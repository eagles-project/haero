...
macro(set_up_platform)
  ...
  if (NOT KOKKOS_KERNELS_LIBRARY)
    set(KOKKOS_KERNELS_LIBRARY libkokkoskernels.a)
  endif()
  if (KOKKOS_KERNELS_LIBRARY_DIR)
    if (NOT EXISTS ${KOKKOS_KERNELS_LIBRARY_DIR}/${KOKKOS_KERNELS_LIBRARY})
      message(FATAL_ERROR "Couldn't find kokkos-kernels library ${KOKKOS_KERNELS_LIBRARY_DIR}/${KOKKOS_KERNELS_LIBRARY}.")
    endif()
    message(STATUS "Using kokkos-kernels library: ${KOKKOS_KERNELS_LIBRARY_DIR}/${KOKKOS_KERNELS_LIBRARY}.")
  else()
    set(KOKKOS_KERNELS_LIBRARY_DIR "${CMAKE_CURRENT_BINARY_DIR}/${CMAKE_INSTALL_LIBDIR}")
    message(STATUS "Building kokkos-kernels library: ${KOKKOS_KERNELS_LIBRARY_DIR}/${KOKKOS_KERNELS_LIBRARY}.")
  endif()
