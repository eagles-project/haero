...
macro(set_up_platform)
  ...
  if (HDF5_LIBRARY)
    ...
    if (CMAKE_BUILD_TYPE STREQUAL "Debug")
      set(HDF5_LIBRARY "${CMAKE_INSTALL_FULL_LIBDIR}/libhdf5_debug.a")
    else()
      set(HDF5_LIBRARY "${CMAKE_INSTALL_FULL_LIBDIR}/libhdf5.a")
    endif()
  endif()
  ...
  if (HDF5_HL_LIBRARY)
    ...
    if (CMAKE_BUILD_TYPE STREQUAL "Debug")
      set(HDF5_HL_LIBRARY "${CMAKE_INSTALL_FULL_LIBDIR}/libhdf5_hl_debug.a")
    else()
      set(HDF5_HL_LIBRARY "${CMAKE_INSTALL_FULL_LIBDIR}/libhdf5_hl.a")
    endif()
  endif()
  ...
  if (NETCDF_LIBRARY)
    ...
    set(NETCDF_LIBRARY "${CMAKE_INSTALL_FULL_LIBDIR}/libnetcdf.a")
  endif()
  ...
  if (NETCDFF_LIBRARY)
    ...
    set(NETCDFF_LIBRARY "${CMAKE_INSTALL_FULL_LIBDIR}/libnetcdff.a")
  endif()
  ...
  if (EKAT_LIBRARY_DIR)
    ...
    set(EKAT_LIBRARY_DIR "${CMAKE_INSTALL_FULL_LIBDIR}")
    message(STATUS "Building yaml-cpp library ${EKAT_LIBRARY_DIR}/${EKAT_LIBRARY}.")
  endif()
  ...
  if (YAMLCPP_LIBRARY_DIR)
    ...
    set(YAMLCPP_LIBRARY_DIR "${CMAKE_INSTALL_FULL_LIBDIR}")
