...
\begin{itemize}
  \item {\bf modal number densities} $n_m$ [\# /m$^3$]: the total number of
        particles per cubic meter in the mode $m$
  \item {\bf aerosol modal mass mix fraction} $q_{m,s}$ [kg aerosol species $s$ /kg air]:
        the ratio of aerosol mass to air mass for aerosol species $s$ occupying
        mode $m$
  \item {\bf gas mole fraction} $q_g$ [kmol gas species $g$/kmol air]: the
        ratio of kilomoles of gas species $g$ to kilomoles of air
\end{itemize}
