...
\newcommand{\pbc}[1]{\textcolor{blue}{\textbf{PB comment:\xspace} #1}} # Pete
\newcommand{\jjc}[1]{\textcolor{teal}{\textbf{JJ comment:\xspace} #1}} # Jeff
\newcommand{\hwc}[1]{\textcolor{green}{\textbf{HW comment:\xspace} #1}} # Hui
\newcommand{\bsc}[1]{\textcolor{orange}{\textbf{BS comment:\xspace} #1}} # Balwinder
\newcommand{\msc}[1]{\textcolor{purple}{\textbf{MS comment:\xspace} #1}} # Mike
\newcommand{\jsc}[1]{\textcolor{pink}{\textbf{JS comment:\xspace} #1}} # Jian
